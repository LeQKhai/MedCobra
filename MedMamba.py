...
def medmamba_t(num_classes=1000, **kwargs):
    return VSSM(depths=[2, 2, 4, 2], dims=[96,192,384,768], num_classes=num_classes, **kwargs)

def medmamba_s(num_classes=1000, **kwargs):
    return VSSM(depths=[2, 2, 8, 2], dims=[96,192,384,768], num_classes=num_classes, **kwargs)

def medmamba_b(num_classes=1000, **kwargs):
    return VSSM(depths=[2, 2, 12, 2], dims=[128,256,512,1024], num_classes=num_classes, **kwargs)
